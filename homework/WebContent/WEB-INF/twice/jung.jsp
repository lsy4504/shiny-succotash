	...
	<div class="people_info section people_spc" id="people_info_z"
		...
		<div class="cont_noline" style="z-index: 10">
			<div class="profile_wrap">
				<div class="big_thumb">
					<img
						src="https://search.pstatic.net/common?type=a&amp;size=120x150&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fpeople%2Fportrait%2F201810%2F20181024120515241-652973.jpg"
						alt="가수 정연 이미지" width="120" height="150"
						onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"><a
						nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.edit&amp;i='+'1800000D_0000002AA360');"
						class="btn_profile_update" href="http://myprofile.naver.com"
						target="_blank"><span class="blind">가수 정연</span>내 프로필 수정</a>
				</div>
				<dl class="detail_profile">
					<dd class="name">
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.namemusic&amp;i='+'1800000D_0000002AA360');"
							href="https://music.naver.com/artist/home.nhn?artistId=460475"
							target="_blank"><strong>정연</strong></a> <span>가수</span>
					</dd>
					<dt>출생</dt>
					<dd>
						<span> 1996년 11월 1일</span>
					</dd>
					<dt>소속그룹</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.group&amp;i='+'1800000D_0000002AA360');"
							href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjky&amp;pkid=1&amp;os=2794338&amp;query=TWICE">TWICE</a>
					</dd>
					<dt>소속사</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.management&amp;i='+'1800000D_0000002AA360');"
							href="?where=nexearch&amp;sm=tab_etc&amp;query=JYP%EC%97%94%ED%84%B0%ED%85%8C%EC%9D%B8%EB%A8%BC%ED%8A%B8">JYP엔터테인먼트</a>
					</dd>
					<dt>수상</dt>
					<dd>2016년 SAF 연예대상 여자 신인상</dd>
					<dt>사이트</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.vlive&amp;i='+'1800000D_0000002AA360');"
		...
		<div class="go_relate">
			<div class="offer_more2">
				<div class="confirm">
					<em>정보확인 <time datetime="2018.10.24.">2018.10.24.</time></em><a
				...
				<div style="left: -65px; width: 286px; visibility: hidden;"
					...
					<div class="layer_tooltip2">
						<div class="content">
							...
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfmy&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
								href="https://myprofile.naver.com/Main.nhn" class="request"
								target="_blank">본인 및 소속사의 인물정보 수정요청</a> <a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfcs&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
			...
			<script type="text/javascript">
				...
				function fnLayerOpen(e) {
					...
					goOtherTCR(this,
							'a=nco_x29*3.imaginf&r=1&i=1800000D_0000002AA360');
				}
				function fnLayerClose(e) {
					$('tooltip_layer').style.visibility = "hidden";
					$('more_div_btn').focus();
					goOtherTCR(this,
							'a=nco_x29*3.imaginfclose&r=1&i=1800000D_0000002AA360');
				}
			</script>
			<a nocr=""
				onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.profiledetail&amp;i='+'1800000D_0000002AA360');"
				href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EC%A0%95%EC%97%B0&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=2794336"
			...
			<div class="lst_cont tvcast " style="display: block;">
				...
				<ul>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
					...
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4488659"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20181110_297%2FnKvlp_1541826167859ykn84_JPEG%2FB120188431_EPI0000_08_B.jpg"
								alt="트와이스 모모♥정연 바디로 썸타는 중??? (feat.정연의 커플댄스 원픽멤버)" width="128"
								height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>59초</em></span>
								<span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4488659"
								class="cast_txt">트와이스 모모♥정연 바디로 썸타는 중???...</a> <span
								class="day_txt">2018.11.10.</span>
						</div>
					</li>
				</ul>
				<a nocr=""
					onclick="return goOtherCR(this, 'a=nco_x29*3.tvcmore&amp;r=1&amp;i=1800000D_0000002AA360&amp;u=' + urlencode(this.href));"
					target="_blank" class="more_view"
					href="http://tv.naver.com/search/clip?query=정연&amp;sort=date"><span
			...
			<div class="lst_cont albumlist" id="tx_ca_people_album_content"
				...
				<ul>
					<li>
						<div class="thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.albumimage&amp;i='+'1800000D_0000002AA360');"
						...
						<dl>
							<dt>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.albumtitle&amp;i='+'1800000D_0000002AA360');"
				...
				<a nocr=""
					onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.wtmusicmore&amp;i='+'1800000D_0000002AA360');"
					class="more_view"
			...
			<div class="lst_cont" id="tx_ca_people_onair_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.dramaimage&amp;i='+'1800000D_0000002AA360');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.dramatitle&amp;i='+'1800000D_0000002AA360');"
					...
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.dramaimage&amp;i='+'1800000D_0000002AA360');"
								href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%223594638%22%7D&amp;pkid=57&amp;os=3594638&amp;query=%EC%A0%95%EA%B8%80%EC%9D%98%EB%B2%95%EC%B9%99%EC%9D%B8%EB%89%B4%EC%B9%BC%EB%A0%88%EB%8F%84%EB%8B%88%EC%95%84"><img
								src="https://search.pstatic.net/common?type=o&amp;size=58x82&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fkeypage%2Fimage%2Fdss%2F57%2F59%2F46%2F38%2F57_3594638_poster_image_1470041376110.jpg"
								alt="정글의 법칙 in 뉴칼레도니아" width="58" height="82"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""></a>
						</div>
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.dramatitle&amp;i='+'1800000D_0000002AA360');"
									href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%223594638%22%7D&amp;pkid=57&amp;os=3594638&amp;query=%EC%A0%95%EA%B8%80%EC%9D%98%EB%B2%95%EC%B9%99%EC%9D%B8%EB%89%B4%EC%B9%BC%EB%A0%88%EB%8F%84%EB%8B%88%EC%95%84"
									title="정글의 법칙 in 뉴칼레도니아">정글의 법칙 in...</a>
							</dd>
							<dd>2016</dd>
						</dl>
					</li>
			...
			<div class="lst_cont" id="tx_ca_people_play_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.playimage&amp;i='+'1800000D_0000002AA360');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794336+'.playtitle&amp;i='+'1800000D_0000002AA360');"
									class="sh_people_title sh_people_link"
									href="https://www.facebook.com/JYPETWICE/photos/a.1597898153825293/2250773045204464/?type=3&amp;theater"
