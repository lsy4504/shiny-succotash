...
<pre>
	...
	2. domain/host : 저장된 쿠키의 재전송 여부를 경절할 때 사용.
	...
	3. maxAge : 만료 시간, 생략하면, 기본값으로 세션의 만료시간이 반영됨.
			-1 : 브라우저의 종료 시점에 삭제.
			0 : 기본의 쿠키가 있을 경우, 해당 쿠키를 삭제할때 사용.
	...
	<% 
		...
		response.addCookie(allPathCookie);//한번 내보내면 밑에 쿠키는 전송안됨 (다시 경로 세팅해줘도)
...
// 		otherDomainCookie.setDomain(".lsy.com");//반드시 현재 쿠키를 생성한 도메인의 하위 도메인만 생성이 가능함
