	...
	<div class="people_info section people_spc" id="people_info_z"
		...
		<div class="cont_noline" style="z-index: 10">
			<div class="profile_wrap">
				<div class="big_thumb">
					<img
						src="https://search.pstatic.net/common?type=a&amp;size=120x150&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fpeople%2Fportrait%2F201810%2F20181026135005667-5447601.jpg"
						alt="가수 다현 이미지" width="120" height="150"
						onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"><a
						nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.edit&amp;i='+'1800000D_0000002AA35B');"
						class="btn_profile_update" href="http://myprofile.naver.com"
						target="_blank"><span class="blind">가수 다현</span>내 프로필 수정</a>
				</div>
				<dl class="detail_profile">
					<dd class="name">
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.namemusic&amp;i='+'1800000D_0000002AA35B');"
							href="https://music.naver.com/artist/home.nhn?artistId=460475"
							target="_blank"><strong>다현</strong></a> <span>가수</span>
					</dd>
					<dt>출생</dt>
					<dd>
						<span> 1998년 5월 28일</span>
					</dd>
					<dt>소속그룹</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.group&amp;i='+'1800000D_0000002AA35B');"
							href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjky&amp;pkid=1&amp;os=2794338&amp;query=TWICE">TWICE</a>
					</dd>
					<dt>소속사</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.management&amp;i='+'1800000D_0000002AA35B');"
							href="?where=nexearch&amp;sm=tab_etc&amp;query=JYP%EC%97%94%ED%84%B0%ED%85%8C%EC%9D%B8%EB%A8%BC%ED%8A%B8">JYP엔터테인먼트</a>
					</dd>
					<dt>사이트</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.vlive&amp;i='+'1800000D_0000002AA35B');"
		...
		<div class="go_relate">
			<div class="offer_more2">
				<div class="confirm">
					<em>정보확인 <time datetime="2018.10.26.">2018.10.26.</time></em><a
				...
				<div style="left: -65px; width: 286px; visibility: hidden;"
					...
					<div class="layer_tooltip2">
						<div class="content">
							...
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfmy&amp;r=1&amp;i=1800000D_0000002AA35B&amp;u=' + urlencode(this.href));"
								href="https://myprofile.naver.com/Main.nhn" class="request"
								target="_blank">본인 및 소속사의 인물정보 수정요청</a> <a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfcs&amp;r=1&amp;i=1800000D_0000002AA35B&amp;u=' + urlencode(this.href));"
			...
			<script type="text/javascript">
				...
				function fnLayerOpen(e) {
					...
					goOtherTCR(this,
							'a=nco_x29*3.imaginf&r=1&i=1800000D_0000002AA35B');
				}
				function fnLayerClose(e) {
					$('tooltip_layer').style.visibility = "hidden";
					$('more_div_btn').focus();
					goOtherTCR(this,
							'a=nco_x29*3.imaginfclose&r=1&i=1800000D_0000002AA35B');
				}
			</script>
			<a nocr=""
				onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.profiledetail&amp;i='+'1800000D_0000002AA35B');"
				href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EB%8B%A4%ED%98%84&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=2794331"
			...
			<div class="lst_cont tvcast " style="display: block;">
				...
				<ul>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_0000002AA35B&amp;u=' + urlencode(this.href));"
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_0000002AA35B&amp;u=' + urlencode(this.href));"
				...
				<a nocr=""
					onclick="return goOtherCR(this, 'a=nco_x29*3.tvcmore&amp;r=1&amp;i=1800000D_0000002AA35B&amp;u=' + urlencode(this.href));"
					target="_blank" class="more_view"
					href="http://tv.naver.com/search/clip?query=다현&amp;sort=date"><span
			...
			<div class="lst_cont albumlist" id="tx_ca_people_album_content"
				...
				<ul>
					<li>
						<div class="thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.albumimage&amp;i='+'1800000D_0000002AA35B');"
						...
						<dl>
							<dt>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.albumtitle&amp;i='+'1800000D_0000002AA35B');"
				...
				<a nocr=""
					onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.wtmusicmore&amp;i='+'1800000D_0000002AA35B');"
					class="more_view"
			...
			<div class="lst_cont" id="tx_ca_people_onair_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.dramaimage&amp;i='+'1800000D_0000002AA35B');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.dramatitle&amp;i='+'1800000D_0000002AA35B');"
			...
			<div class="lst_cont" id="tx_ca_people_play_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.playimage&amp;i='+'1800000D_0000002AA35B');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_2794331+'.playtitle&amp;i='+'1800000D_0000002AA35B');"
									class="sh_people_title sh_people_link"
									href="https://www.facebook.com/JYPETWICE/photos/a.1597898153825293/2250773045204464/?type=3&amp;theater"
